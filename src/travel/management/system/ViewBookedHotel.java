    ...
    public ViewBookedHotel(String username) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                l2.setText(rs.getString("choice"));
                l3.setText(rs.getString("total"));
                l4.setText(rs.getString("noday"));
                l5.setText(rs.getString("choice2"));
                l6.setText(rs.getString("choice3"));
                l7.setText(rs.getString("id"));
                l8.setText(rs.getString("number"));
                l9.setText(rs.getString("phone"));
                l10.setText(rs.getString("totalprice"));
