...
public class DeleteCustomer extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
                                    //DeleteCustomer frame = new DeleteCustomer(username);
	...
	public DeleteCustomer() {
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
                                ResultSet rs = c.s.executeQuery("select * from customer where s9 = '"+c1.getSelectedItem()+"'");
                                if(rs.next()){
                                    l2.setText(rs.getString("s1"));  
                                    l3.setText(rs.getString("s2"));
                                    l4.setText(rs.getString("s3"));  
                                    l5.setText(rs.getString("s4"));
                                    l6.setText(rs.getString("s5"));  
                                    l7.setText(rs.getString("s7"));
                                    l8.setText(rs.getString("s8"));  
                                    l9.setText(rs.getString("s10"));
                                }
                            }catch(Exception ee){ }
                        }
		});
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                c.s.executeUpdate("delete from account1 where username = '"+s1+"'");
                                
                                c.s.executeUpdate("delete from customer where s9 = '"+s1+"'");
