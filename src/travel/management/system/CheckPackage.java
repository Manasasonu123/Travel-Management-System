...
public class CheckPackage extends JFrame {
    ...
    CheckPackage() {   
      ...
      String[] package3 = new String[]{"package3.jpg","BRONZE PACKAGE","6 days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "BBQ Dinner", "BOOK NOW", "Mansoon Special", "Rs 32000 only"};
    ...
    public JPanel createPackage(String[] pack){
        ...
        lblDeposite.setFont(new Font("Yu Mincho", Font.BOLD, 25));
        lblDeposite.setBounds(250, 460, 400, 40);
        p1.add(lblDeposite);
    ...
    private JPanel createpackage(String string) {
