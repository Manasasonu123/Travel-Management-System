...
public class Login extends JFrame implements ActionListener{
	...
	panel.add(l5);
		...
		try {
                ...
                String qry="select * from account1 where username='"+username+"' AND password='"+password+"'";
                Conn c=new Conn();
                //PreparedStatement st = c.c.prepareStatement(qry);

                   //st.setString(1, textField.getText());
                    //st.setString(2, passwordField.getText());
                ResultSet r=c.s.executeQuery(qry);
                if(r.next()){
                    setVisible(false);
